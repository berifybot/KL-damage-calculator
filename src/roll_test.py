...
class TestRoll(unittest.TestCase):
    ...
    def test_default_creation(self):
        roll = Roll(50, self.test_dragon, TEST_DAMAGE_TYPE)
        self.assertEqual(roll.damage, 50)

    def test_1_roll(self):
        roll = Roll(50, self.test_dragon, TEST_DAMAGE_TYPE, lambda: 1)
        roll.execute_roll()
    ...
    def test_2_roll(self):
        roll = Roll(50, self.test_dragon, TEST_DAMAGE_TYPE, lambda: 2)
        roll.execute_roll()
    ...
    def test_3_roll_no_round(self):
        roll = Roll(50, self.test_dragon, TEST_DAMAGE_TYPE, lambda: 3)
        roll.execute_roll()
    ...
    def test_3_roll_with_round(self):
        # Round down
        roll = Roll(51, self.test_dragon, TEST_DAMAGE_TYPE, lambda: 3)
        roll.execute_roll()
        self.assertEqual(roll.roll, 3)
        self.assertEqual(roll.damage_dealt, 25)
        self.assertEqual(roll.enemy.current_health, 475)
    ...
    def test_4_roll(self):
        roll = Roll(50, self.test_dragon, TEST_DAMAGE_TYPE, lambda: 4)
        roll.execute_roll()
    ...
    def test_5_roll(self):
        roll = Roll(50, self.test_dragon, TEST_DAMAGE_TYPE, lambda: 5)
        roll.execute_roll()
    ...
    def test_6_roll(self):
        roll = Roll(50, self.test_dragon, TEST_DAMAGE_TYPE, lambda: 6)
        roll.execute_roll()
    ...
    def test_invalid_roll_raises_exception(self):
        roll = Roll(50, self.test_dragon, TEST_DAMAGE_TYPE, lambda: 7)
        self.assertRaises(Exception, roll.execute_roll)

    def test_weakness_damage(self):
        roll = Roll(50, self.test_dragon, "melee", lambda: 4)
        roll.execute_roll()
        self.assertEqual(roll.roll, 4)
        self.assertEqual(roll.damage_dealt, 60)
        self.assertEqual(roll.enemy.current_health, 440)
